				...
				<table width="600" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td align="center" valign="top" bgcolor="#d3be6c"
							...
							<div>
								<br>Online Book Store is an application where you u can order any book from the store for your further studies...<br>
								spring ,spring boot ,hibernate , web services and micro service
								<br> ""This application is created to share the knowledge and
